...
**Health Twin AI**는 사용자의 임상 데이터(나이, 성별, 콜레스테롤, 수축기 혈압, 당뇨 여부 등)와 평상시 생활습관(주당 운동 횟수, 하루 수면 시간)을 분석하여, 향후 10년 내 심혈관 질환 발생 위험도를 산출하고 최적의 예방 행동 변화 시나리오(Counterfactual Top 3)를 예측하는 인공지능 헬스케어 플랫폼입니다.
